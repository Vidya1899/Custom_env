...
import numpy as np
#from my_custom_env import envs

import gym 
env = gym.make("Foraging_env-100x100-10p-10f-v0")
...
import random
import gym
import my_custom_env.envs
#env = gym.make("CartPole-v1")
def Foraging_env(gym.env):
    env=gym.make("Foraging_env-8x8-2p-1f-v0")
